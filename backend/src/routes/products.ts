...
import { createManyProducts, createProduct, deleteProduct, getProductById, listProducts, updateProduct } from '../controllers/products';
...
productsRoutes.post('/createMany', [authMiddleware, adminMiddleware], errorHandler(createManyProducts));
